...
(function() {
    ...
    e.prototype.token = function(e, n) {
        ...
        while (e) {
            ...
            if (r = this.rules.code.exec(e)) {
                ...
                this.tokens.push({
                    type: "code",
                    text: !this.options.pedantic ? r.replace(/\n+$/, "") : r
                });
                continue
            }
    ...
    s.prototype.outputLink = function(t, e) {
        if (t[0][0] !== "!") {
            ...
            return '<a data-lightbox="image-1" data-title="' + r(t[1])+ '" href="' + prefixUrl + (r(e.href)).replace('..', '') + '" class="content-img"><img src="' + prefixUrl + (r(e.href)).replace('..', '') + '" alt="' + r(t[1]) + '"' + (e.title ? ' title="' + r(e.title) + '"' : "") + "></a>"
        }
    };
    ...
    i.prototype.tok = function() {
        switch (this.token.type) {
            ...
            case "list_start":
                {
                    var h = this.token.ordered ? "ol" : "ul",
                        e = "";
...
(function(r) {
    ...
    Flatdoc.slugify = function(s, num_chars) {
        s = downcode(s);
        s = s.replace(/[^-\w\s]/g, "");
        s = s.replace(/^\s+|\s+$/g, "");
        s = s.replace(/[-\s]+/g, "-");
